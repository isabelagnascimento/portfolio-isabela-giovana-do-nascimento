# Isabela Nascimento
> Estudante de Ciência da Computação | Foco em Dados
...
* **Habilidades Técnicas:** Python, SQL, Excel Avançado.
* **Habilidades Socioemocionais:** Visão estratégica, análise de métricas e pensamento crítico.
* **Experiência/Projetos Relevantes:** Atuei como Gerente de Mídia LATAM onde desenvolvi a automação de relatórios e dashboards utilizando Looker Studio e Supermetrics para monitoramento de campanhas de grande volume de dados no universo gamer.
...
#### 📊 Ferramentas de Dados & Desenvolvimento
